...
def load_data(root_dir, data_dir, data_folder, subject, session):
    subject = 'sub'+str(subject)
    sub_dir = os.path.join(root_dir, data_dir, session, data_folder)
    file_path = os.path.join(sub_dir, subject+'.npz')
    print(file_path)
